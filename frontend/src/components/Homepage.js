            ...
            {Object.entries(versions).map(([key, value]) => (
              <div key={key} className={"col s12 m6"}>
                <div className={`card ${key === 'Version 0.0.2' ? 'blue-grey darken-3 z-depth-5' : 'blue-grey darken-1'}`}>
                  <div className="card-content white-text" style={{ height: '500px' }}>
        ...
        <div className="col s12 m6">
          <div class="card">
            ...
            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4">{product.name}<i class="material-icons right">more_horiz</i></span>
            </div>
